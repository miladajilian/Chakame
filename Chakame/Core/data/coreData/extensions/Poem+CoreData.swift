...
extension Poem: UUIDIdentifiable {
    ...
    private func checkForExistingPoem
    (
        id: Int,
...
//        }
        ...
        /* checking for parentId to ensure that poems are updated correctly.
           sometimes updates may occur without a parentId, causing unintended retention. */
