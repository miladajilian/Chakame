...
extension Poet {
    ...
    static let mock = loadPoets().first ?? Poet(id: 0,
                                                name: nil,
                                                description: nil,
                                                fullUrl: nil,
                                                rootCatId: nil,
                                                ...
                                                published: nil,
                                                imageUrl: nil,
                                                birthYearInLHijri: nil,
                                                validBirthDate: nil,
                                                deathYearInLHijri: nil,
                                                validDeathDate: nil,
                                                pinOrder: nil,
                                                birthPlace: nil,
                                                birthPlaceLatitude: nil,
                                                birthPlaceLongitude: nil,
                                                deathPlaceLatitude: nil,
                                                deathPlaceLongitude: nil,
                                                deathPlace: nil)
}
